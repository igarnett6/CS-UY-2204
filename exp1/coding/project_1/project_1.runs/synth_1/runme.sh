...
HD_PWD='S:/cs2204/exp1/coding/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log crypto.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source crypto.tcl
