...
HD_PWD='S:/cs2204/exp1/coding/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log crypto.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source crypto.tcl -notrace
