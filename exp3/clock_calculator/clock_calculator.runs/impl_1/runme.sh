...
HD_PWD='S:/cs2204/exp3/clock_calculator/clock_calculator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clockCalculator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clockCalculator.tcl -notrace
