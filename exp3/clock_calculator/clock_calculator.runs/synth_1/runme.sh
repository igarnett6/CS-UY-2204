...
HD_PWD='S:/cs2204/exp3/clock_calculator/clock_calculator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clockCalculator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clockCalculator.tcl
